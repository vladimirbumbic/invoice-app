                        ...
                        {(props) => (
                            <SimpleBar style={{ maxHeight: '100%' }}>
                                ...
                                >
                                    ...
                                    <p className="text-gray5 text-lg1 font-bold">
                                        Item List
                                    </p>
                                    <FieldArray
                                        name="itemList"
